 ...
 * @author jcjimenezr
 */
public class pruebaVerificarAlineacion {
    ...
    public void testVerificarAlineacion() {
        ...
        assertEquals(tablero.verificarAlineacion(), true);
        coordenada.clear();
    }
    ...
    @Test
    public void testVerificarAlienacion3() {
    ...
    @Test
    public void testVerificarAlienacion4() {
        Coordenada coord1 = new Coordenada(0,0);
        Coordenada coord3 = new Coordenada(1,1);
        coordenada.add(coord1);
        coordenada.add(coord3);
        tablero.setCoordenada(coordenada);
        assertEquals(tablero.verificarAlineacion(), false);
        coordenada.clear();
    }    
}
